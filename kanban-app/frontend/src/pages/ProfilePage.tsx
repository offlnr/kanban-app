  ...
  if (avatarUrl) {
    return (
      <img
        src={avatarUrl}
        alt={fullName}
        className={`${cls} rounded-full object-cover border-2 border-gray-200`}
      />
    )
  }

  return (
    <div className={`${cls} rounded-full bg-indigo-100 flex items-center justify-center font-semibold text-indigo-700 border-2 border-gray-200 select-none`}>
      {initials || '?'}
    </div>
  )
}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">KanbanApp</span>
          </div>
        </div>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        {/* Avatar + info section */}
        <form onSubmit={handleSaveInfo} className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
          <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">{t('profile.section_info')}</h2>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-gray-400">{t('profile.avatar_hint')}</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSavePassword} className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">{t('profile.section_password')}</h2>
            <button
              type="button"
          ...
          {!showPassword && (
            <p className="text-sm text-gray-400">{t('profile.password_description')}</p>
          )}
        </form>

        {/* Danger zone */}
        <div className="bg-white border border-red-100 rounded-xl p-6">
          <h2 className="text-sm font-semibold text-red-600 uppercase tracking-wide mb-3">{t('profile.section_account')}</h2>
          <button
            type="button"
            onClick={logout}
